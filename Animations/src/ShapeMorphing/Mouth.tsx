...
import {addCurve, close, createPath, interpolatePath, serialize} from 'react-native-redash';
...
const Mouth = ({progress}: MouthProps) => {
	const animatedProps = useAnimatedProps(() => ({
		d: interpolatePath(progress.value, [0, 0.5, 1], [
			angryPath,
			normalPath,
			goodPath,
		])
	...
	return(
		<Svg width={120} height={40} viewBox='0 0 120 40'>
			<AnimatedPath animatedProps={animatedProps} fill='transparent' stroke='black' strokeWidth='4'/>
		</Svg>
	);
};
